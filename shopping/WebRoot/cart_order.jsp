...
if(!rs_user.next()){
	...
	if(flag.equals("false")){
		out.println("<script language='javascript'>alert('Invalid order');history.back();</script>");
	}else{
		session.removeAttribute("cart");
		out.println("<script language='javascript'>alert('Order confirmed, please remmember your order ID["+orderID+"]');window.location.href='index.jsp';</script>");
	}
	conn.close();
}
}catch(Exception e){
