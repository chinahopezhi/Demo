...
if (!rs.next()){
	...
	if (ret!=0){
          out.println("<script language='javascript'>alert('Goods is deleted successfully!');window.location.href='index.jsp';</script>");
        }else{
          out.println("<script language='javascript'>alert('Goods can not be deleted!');window.location.href='index.jsp';</script>");
        }
}
