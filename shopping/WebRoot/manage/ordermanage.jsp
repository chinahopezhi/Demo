...
<table width="100%" height="48"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#CCCCCC" bordercolorlight="#FFFFFF">
                    <tr align="center">
                      <td width="8%" height="30">OrderNo</td>
                      <td width="8%">Class</td>
                      <td width="10%">RealName</td>
                      <td width="15%">PayMethod</td>
                      <td width="17%">ShipMethod</td>
                      <td width="26%">OrderDate</td>
                      <td width="10%">Work</td>
                    </tr>
<%
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="24" align="right">CPage：[<%=Page%>/<%=maxPage%>]&nbsp;
	<%if(Page>1){%>
	<a href="ordermanage.jsp?Page=1">FPage</a>　<a href="ordermanage.jsp?Page=<%=Page-1%>">PPage</a>
	<%
	}
	if(Page<maxPage){
	%>
	　<a href="ordermanage.jsp?Page=<%=Page+1%>">NPage</a>　<a href="ordermanage.jsp?Page=<%=maxPage%>">LPage&nbsp;</a>
	<%}
	%>	</td>
  </tr>
</table>		  </td>
