...
if (rs.next()){
	out.println("<script language='javascript'>alert('The goods has been added!');window.location.href='goods_add.jsp';</script>");
}else{
	int ret=0;
        GoodsDaoImpl ins_goods=new GoodsDaoImpl();
        ret=ins_goods.insert(goods);
	if (ret!=0){
          out.println("<script language='javascript'>alert('Goods is added successfully!');window.location.href='index.jsp';</script>");
        }else{
          out.println("<script language='javascript'>alert('Goods is added failed!');//window.location.href='goods_add.jsp';</script>");
        }
}
%>