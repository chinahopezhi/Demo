...
<table width="100%" height="14"  border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="100%" height="48"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#CCCCCC" bordercolorlight="#FFFFFF">
              <tr bgcolor="#eeeeee">
                <td width="22%" height="24" align="center">Name</td>
                <td width="40%" align="center">Details</td>
                <td width="11%" align="center">New?</td>
                <td width="11%" align="center">On Sale?</td>
                <td width="8%" align="center">Revise</td>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="right">CPage：[<%=Page%>/<%=maxPage%>]&nbsp;
	<%if(Page>1){%>
	<a href="index.jsp?Page=1">FPage</a>　<a href="index.jsp?Page=<%=Page-1%>">PPage</a>
	<%
	}
	if(Page<maxPage){
	%>
	　<a href="index.jsp?Page=<%=Page+1%>">NPage</a>　<a href="index.jsp?Page=<%=maxPage%>">LPage&nbsp;</a>
	<%}
	%>
	</td>
  </tr>
