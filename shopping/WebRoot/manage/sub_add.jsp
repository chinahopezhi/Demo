...
function mycheck(){
	if (form1.typename.value==""){
		alert("Please input small department！");form1.typename.focus();return;
	}
	form1.submit();
}
</script>
    ...
    <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top" background="../images/manage_center_subAdd.gif"><table width="100%" height="36"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="98%" align="right"><a href="subType.jsp">[ <img src="../images/list.gif" width="11" height="13">&nbsp;Small Department Management]</a></td>
            <td width="2%">&nbsp;</td>
          </tr>
        </table></td>
      </tr>
        ...
        <tr>
          <td valign="top">
			    ...
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
                    <td height="50">Select large department：</td>
				  ...
				  <tr>
                    <td width="17%" height="50">Small Department：</td>
...
<input name="Submit2" type="reset" class="btn_grey" value="Reset">
                        &nbsp;
                        <input name="Submit3" type="button" class="btn_grey" value="Back" onClick="JScript:window.location.href='superType.jsp';">                    </td>
                    </tr>
                </table>
			  </form>
          </td>
