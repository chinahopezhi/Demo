...
function mycheck(){
	if (form1.typename.value==""){
		alert("Please input large department！");form1.typename.focus();return;
	}
	form1.submit();
}
</script>
    ...
    <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top" background="../images/manage_center_superAdd.gif"><table width="100%" height="36"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="98%" align="right"><a href="superType.jsp">[ <img src="../images/list.gif" width="11" height="13">&nbsp;Large Department Management]</a></td>
            <td width="2%">&nbsp;</td>
          </tr>
        </table></td>
      </tr>
        ...
        <tr>
          <td valign="top">
			    ...
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
                    <td height="45">Large Department：</td>
